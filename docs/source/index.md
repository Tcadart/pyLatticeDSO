...
1. Follow the [Installation Tutorial](guides/Installation_tutorial.md) to set up your environment
2. Check out the [Examples](guides/Examples.md) for practical usage scenarios
3. Learn about [Cell Geometries](guides/cell_geometries.md) to create custom unit cells
